        ...
        {result && (
          <div id="report-content" className="mt-6 space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-black">JD Match</h3>
              <p className="text-2xl font-bold text-blue-600">{result.JDMatch}</p>
            </div>

            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-black">Score Breakdown</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Keyword Match</p>
                  <p className="text-lg text-black font-bold">{result.ScoreBreakdown.KeywordMatch}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Experience Match</p>
                  <p className="text-lg text-black font-bold">{result.ScoreBreakdown.ExperienceMatch}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Skills Match</p>
                  <p className="text-lg text-black font-bold">{result.ScoreBreakdown.SkillsMatch}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Education Match</p>
                  <p className="text-lg text-black font-bold">{result.ScoreBreakdown.EducationMatch}</p>
                </div>
              </div>
            </div>

            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-black">Missing Keywords</h3>
            ...
            {showTopics && keywordTopics && (
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-black">Keyword Topics</h3>
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-black">Profile Summary</h3>
